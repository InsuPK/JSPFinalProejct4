package com.example.jspfinalproejct4.dao;
...
import com.example.jspfinalproejct4.util.JDBCUtil;
...
public class BoardDAO {
	...
	public int updateBoard(BoardVO vo) {
		...
		try {
			...
			//vo.getPhoto() + "-" +
			System.out.println(vo.getCategory() + "-" + vo.getCategory() + "-" + vo.getTitle() + "-" + vo.getWriter() + "-" + vo.getContent() + "-" + vo.getSeq());
			stmt.executeUpdate();
			return 1;
	...
	public BoardVO getBoard(int seq) {
		...
		try {
			...
			if(rs.next()) {
				...
				one.setUpdate(rs.getDate("updatedAt"));
	...
	public String getPhotoFilename(int sid) {
		...
		System.out.println("===> JDBC로 getPhotoFilename() 기능 처");
		return filename;
	}
